      ...
      <YStack flex={1} padding="$4">
        <XStack alignItems="center" justifyContent="space-between" marginBottom="$4">
          ...
          <XStack space="$2">
            ...
            >
              <Text color="$green11">{t("Read All")}</Text>
            </Button>
            ...
            >
              <Text color="$red11">{t("Clear All")}</Text>
            </Button>
          </XStack>
        </XStack>
            ...
            {notifications.length === 0 ? (
              <Card padding="$6" alignItems="center" justifyContent="center" backgroundColor="$gray2">
                <Text color="$gray11" textAlign="center">
                  {t("No notifications yet. Tap the \"Test\" button to create a sample notification.")}
                </Text>
              </Card>
            ) : (
                      ...
                      <XStack alignItems="center" justifyContent="space-between">
                        ...
                        {!notification.read && (
                          <Card backgroundColor="$blue9" paddingHorizontal="$2" paddingVertical="$1" borderRadius="$10">
                            <Text color="white" fontSize="$1">{t("NEW")}</Text>
                          </Card>
                        )}
                      </XStack>

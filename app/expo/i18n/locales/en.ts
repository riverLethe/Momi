export default {
  translation: {
    ...
    "Bill does not exist or has been deleted":
      "Bill does not exist or has been deleted",
    ...
    "Start tracking your expenses to see reports":
      "Start tracking your expenses to see reports",
    ...
    "You can talk to our AI assistant just like chatting with a friend":
      "You can talk to our AI assistant just like chatting with a friend",
    "Try saying: 'I spent $25 on lunch today'":
      "Try saying: 'I spent $25 on lunch today'",
    ...
    Camera: "Camera",
    File: "File",
    "Media library permission denied": "Media library permission denied",
    "Camera permission denied": "Camera permission denied",
    "Failed to take photo": "Failed to take photo",
    ...
    "⚠️  Recording error: {{error}}": "⚠️  Recording error: {{error}}",
    "Action: ": "Action: ",
    "Score Details": "Score Details",
    Close: "Close",
    Overspending: "Overspending",
    "Budget Not Used": "Budget Not Used",
    "Spending Volatility": "Spending Volatility",

export default {
  translation: {
    ...
    "No Bills": "Sin Facturas",
    "Please login to view family bills":
      "Inicie sesión para ver facturas familiares",
    "Try changing filters": "Intente cambiar los filtros",
    Today: "Hoy",
    Yesterday: "Ayer",
    ...
    // CSV Export
    "MomiQ Expense Bill Details": "Detalles de Gastos de MomiQ",
    Period: "Periodo",
    "Export Time": "Hora de exportación",
    "MomiQ Transaction Bill Details List":
      "Lista de Detalles de Transacciones de MomiQ",
    "Created Time": "Hora de creación",
    "Transaction Time": "Hora de transacción",
    Type: "Tipo",
    Amount: "Cantidad",
    Expense: "Gasto",
    "Total {{count}} transactions": "Total de {{count}} transacciones",
    Apply: "Aplicar",
    "Select Date": "Seleccionar Fecha",
    "Enter notes...": "Escribir notas...",
    "Enter merchant name": "Escribir nombre del comercio",
    "Exceeding by {{percentage}}%": "Excedido en {{percentage}}%",
    "Save {{percentage}}%": "Ahorrar {{percentage}}%",
    Normal: "Normal",
    ...
    "Action: ": "Acción: ",
    "Score Details": "Detalles de la puntuación",
    Close: "Cerrar",
    Overspending: "Gasto excesivo",
    "Budget Not Used": "Presupuesto no utilizado",
    "Spending Volatility": "Volatilidad del gasto",
    "Category Momentum": "Momentum de la categoría",
    "Savings Opportunity": "Oportunidad de ahorro",
    "Recurring Risk": "Riesgo recurrente",
    Cashflow: "Flujo de caja",
    "Refreshing...": "Actualizando...",
    "Refresh insights": "Actualizar información",
    ...
    "Budget 80% used": "Presupuesto utilizado 80%",
    "You have spent 80% of your {{period}} budget.":
      "Has gastado el 80% de tu presupuesto {{period}}.",
    "Budget exceeded": "Presupuesto excedido",
    "You have reached 100% of your {{period}} budget.":
      "Has alcanzado el 100% de tu presupuesto {{period}}.",
